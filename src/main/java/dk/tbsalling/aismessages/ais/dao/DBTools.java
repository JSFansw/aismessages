...
public class DBTools {
	...
	//向基站表写数据
		...
		//向位置表中写数据
		public void insert2Position(int timeStamp,int mmsi,float latitude,float longitude,float heading,float course,float speed){
			String sqlStr = "insert into ais_position (time,mmsi,latitude,longitude,heading,course,speed) values(" + timeStamp + "," + mmsi
