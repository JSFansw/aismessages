...
public class ConnectionPool {
	 ...
	 *            String 连接数据库用户名
	 * @param dbPassword
	 *            String 连接数据库用户的密码 connPool = new
	 *            ConnectionPool("com.mysql.jdbc.Driver",
	 *            "jdbc:mysql://127.0.0.1:3306/aisPython", "root", "123");
	 */
	...
	private static ConnectionPool single = null;
	...
	public static ConnectionPool getInstance() {
		if (single == null) {
			return new ConnectionPool("com.mysql.jdbc.Driver", "jdbc:mysql://58.217.99.137/hl_ais", "root", "root");
		} else {
			return single;
		}
	}
